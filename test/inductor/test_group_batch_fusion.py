...
@requires_cuda()
@torch._inductor.config.patch(post_grad_fusion_options={"group_linear": {"require_fbgemm": True}})
...
@requires_cuda()
@torch._inductor.config.patch(post_grad_fusion_options={"batch_linear": {"require_fbgemm": False}})
